...
function HM:mango()
	...
	local moveTween = TweenSv:Create(imageLabel, moveTweenInfo, moveGoal)

	local fadeInGoal = {ImageTransparency = 0}
	local fadeOutGoal = {ImageTransparency = 1}

	local fadeInTween = TweenSv:Create(imageLabel, fadeTweenInfo, fadeInGoal)
	local fadeOutTween = TweenSv:Create(imageLabel, fadeTweenInfo, fadeOutGoal)
...
function HM.new(self)
	...
	do
		...
		function DropdownSyyu:Init(data : {string | any}, Default : string | any, Multi : boolean, BaseFrame : Frame , Callback : any)
		...
		function obj:AddSection(dick)
			...
			do
				...
				function dick:AddDropdown(property)
					...
					Button.MouseButton1Click:Connect(function()
						DropdownSyu:Close();
						DropdownSyu:Init(property.Values,property.Default,property.Multi,mv,UpdateFrame);
					end);
