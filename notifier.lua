...
local Player = game:GetService("Players").LocalPlayer;alocal TweenService = game:GetService("TweenService");
local RunService = game:GetService("RunService");
local TextService = game:GetService("TextService");
local sound = Instance.new("Sound")
...
return {
	Notify = function(Properties)
		...
		sound.SoundId = getcustomasset(Properties.SoundID) or "rbxassetid://8551372796"
		sound.Volume = Properties.Volume or 60
		sound.Looped = false
		sound:Play()
